...
const TooltipTriangle: any =
  'https://img.icons8.com/pastel-glyph/452/hyperlink--v2.png';
...
export const LinkStyledButton = styled.button<{ disabled?: boolean }>`
  ...
  color: ${({ theme, disabled }) =>
    disabled ? theme.deprecated_text2 : theme.deprecated_primary1};
  font-weight: 500;
...
export const Separator = styled.div<{ redesignFlag?: boolean }>`
  ...
  background-color: ${({ theme, redesignFlag }) =>
    redesignFlag ? theme.backgroundOutline : theme.deprecated_bg2};
`;
