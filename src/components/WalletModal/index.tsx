...
const Wrapper = styled.div<{ redesignFlag?: boolean }>`
  ...
  outline: ${({ theme, redesignFlag }) =>
    redesignFlag && `1px solid ${theme.backgroundOutline}`};
...
const ContentWrapper = styled.div<{ redesignFlag?: boolean }>`
  background-color: ${({ theme, redesignFlag }) =>
    redesignFlag ? theme.backgroundSurface : theme.deprecated_bg0};
  border: ${({ theme, redesignFlag }) =>
    redesignFlag && `1px solid ${theme.backgroundOutline}`};
